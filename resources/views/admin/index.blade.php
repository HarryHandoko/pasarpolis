...
<div class="card bg-white pt-2 pb-2">
    <x-table>
        ...
        <x-slot name="urlAdd">{{ route('admin.admin.add') }}</x-slot>
        <x-slot name="thead">
            <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-group-append">
                                ...
                                <a class="dropdown-item" href="{{ route('admin.admin.edit',$item->id) }}" ><i data-feather="eye"></i> Lihat Detail</a>
    ...
    function deletes(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = '{{ route("admin.admin.delete", ":id") }}';
