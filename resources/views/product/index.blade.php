...
<div class="card bg-white pt-2 pb-2">
    <x-table>
        ...
        <x-slot name="urlAdd">{{ route('admin.product.add') }}</x-slot>
        <x-slot name="thead">
            <tr>
        ...
        <x-slot name="tbody">
            @foreach ($data as $key => $item)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.product_benefit',$item->id) }}" class="btn btn-warning"><i data-feather="eye"></i> Benefit</button>
                        </td>
                        <td>
                            <div class="input-group-append">
                                ...
                                <a class="dropdown-item" href="{{ route('admin.product.edit',$item->id) }}" ><i data-feather="eye"></i> Lihat Detail</a>
